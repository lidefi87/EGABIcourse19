...
## solicitemos sugerencias en nuestra región de estudio para añadir a nuestro mapa
xns <- an_suggest(xn, map_scale = 20e6, map_extent = extent(pr))

## transformemos a nuestra proyección, convirtimos datos a dataframe (marco de datos), mostramos las primeros 10 filas
