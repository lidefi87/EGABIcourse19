# Modelos de distribución de especies (SDM - species distribution models)

Los scripts de los ejercicios se encuentran al final de esta página.

## SDM introduction and review

Que son los modelos de distribución de especies  ?
...
Comprender y generar resultados SDM.
...
**Ejercicio - ejecuta tu primer SDM**
...
#### Abrir datos medioambientales y de ocurrencia (run_yOur_SDM.R file)
#---------------------------------------------------------
# compute there the MATRIX_OCC_ENVI variable (1 set)
# en el archivo run_yOur_SDM.R, ejecutar hasta la definicion de MyFold 
# para set.seed(1) (j=1)
# ejecuta el modelo y compara la desviacion predictiva segun el conjuntos de parametros elegidos
#=============================================================
source("scripts/Function_gbm.R")
tc=4   # complejidad del arbol
lr=0.011 # tasa de aprendizaje
bf=0.8 # fraccion de bolsa
...
clock4 <- function(occ, bg.coords){
  ...
  # muestrear un numero aleatorio entre -180 y 190 para definir el transecto de muestreo aleatorio
...
.roc <-function (obsdat, preddat) {
  # codigo adaptado de Ferrier, Pearce and Watson's code, by J.Elith
  #
  # referir a:
  ...
  # en dismo, esto se usa en las rutinas gbm, pero no en otros casos (referir a seccion 'evaluate').
...
.calibration <- function(obs, preds, family = "binomial")  {
  #
  # j elith/j leathwick 17 de Marzo 2005
...
#########################################################
#########  GRUPOS DE EVALUACION DE BLOQUES	#############
#########################################################

get.block <- function(occ, bg.coords){
  # DIVIDIR PUNTOS OCC EN CUATRO PUNTOS ESPACIALES
  noccs <- nrow(occ)
