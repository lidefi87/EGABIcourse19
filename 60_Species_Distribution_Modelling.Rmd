...
#### Importa datos ambientales y de ocurrencia (archivo run_yOur_SDM.R)
#---------------------------------------------------------
...
#---------------------------------
occ.sterechinus <- read.csv("docs/course_material/exercises/data/occurrences_sterechinus.csv", header=T, sep=";")
